...
class ExamplePlugin extends StandardPlugin:
  val name: String = "ExamplePlugin"
  override val description: String = "Example Plugin"
  override def init(options: List[String]): List[PluginPhase] =
    ExamplePhase() :: Nil
end ExamplePlugin

class ExamplePhase() extends PluginPhase:
  override def phaseName: String = ExamplePhase.name
